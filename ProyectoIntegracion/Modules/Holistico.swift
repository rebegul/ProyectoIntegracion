...
extension Holistico{
    static func listaHolistico()->[Holistico]{
        return [
            ...
            Holistico(nombre: "Reiki", desc:"SEs un método de canalización y transmisión de energía vital para que la persona obtenga paz y equilibrio físico, mental, emocional y espiritual"),
