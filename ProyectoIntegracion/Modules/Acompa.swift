...
extension Acompa{
    static func listaAcompa()->[Acompa]{
        return [
            Acompa(nombre: "Tanatología", desc:"Proceso de encuentro personal en donde a través de un diálogo con la ayuda de técnicas y herramientas tanatológicas la persona identifica y reconoce sus emociones ante una pérdida."),
